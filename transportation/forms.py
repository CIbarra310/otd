...
class NewRunRequest(forms.ModelForm):
    ...
    ready_time = forms.TimeField(widget=forms.DateInput(attrs={'type': 'time', 'class': 'form-control time'}))
    need_by_this_time = forms.TimeField(widget=forms.DateInput(attrs={'type': 'time', 'class': 'form-control time'}))
    ...
    transportation_notes = forms.CharField(widget=forms.Textarea(attrs={'rows': 3, 'class': 'form-control'}))
    driver_notes = forms.CharField(widget=forms.Textarea(attrs={'rows': 3, 'class': 'form-control'}))
